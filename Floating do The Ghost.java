...
public class FloatingModMenuService extends Service {
    ...
    int TEXT_COLOR = Color.parseColor("#0000f1");
    int TEXT_COLOR_2 = Color.parseColor("#0000f2");
    int BTN_COLOR = Color.parseColor("#20B2AA");
    int MENU_BG_COLOR = Color.parseColor("#1c1c1c"); //#AARRGGBB
    int MENU_FEATURE_BG_COLOR = Color.parseColor("#000000"); //#AARRGGBB
    int MENU_WIDTH = 310;
    int MENU_HEIGHT = 210;
    float MENU_CORNER = 4f;
    int ICON_SIZE = 90; //Change both width and height of image
    float ICON_ALPHA = 1f; //Transparent
    int ToggleON = Color.GREEN;
    int ToggleOFF = Color.RED;
    int BtnON = Color.parseColor("#E0FFFF");
    int BtnOFF = Color.parseColor("#F0F8FF");
    int CategoryBG = Color.parseColor("#1b1b1b");
    int SeekBarColor = Color.parseColor("#0000fd");
    int SeekBarProgressColor = Color.parseColor("#00BFFF");
    ...
    private void initFloating() {
        ...
        gdMenuBody.setStroke(4, Color.parseColor("#ff0000")); //Set border
    ...
    //********** Close button **********
        ...
        lParamsCloseBtn.addRule(ALIGN_PARENT_LEFT);
        ...
        handler.postDelayed(new Runnable() {
				...
				public void run() {
					...
					if (Preferences.loadPref && !isGameLibLoaded() && !stopChecking) {
						if (!viewLoaded) {
							patches.addView(Category("Ola Você Salvou o Layout, Para Voltar Com layout Clica no Button Voltar Layout"));
							patches.addView(Button(-100, "Voltar Com Layout"));
							viewLoaded = true;
						}
